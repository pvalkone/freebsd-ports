...
static const char *colorname[] = {
        "#2b303b",              /* 0: ANSI Color 0 */
        "#bf616a",              /* 1: ANSI Color 1 */
        "#a3be8c",              /* 2: ANSI Color 2 */
        "#ebcb8b",              /* 3: ANSI Color 3 */
        "#8fa1b3",              /* 4: ANSI Color 4 */
        "#b48ead",              /* 5: ANSI Color 5 */
        "#96b5b4",              /* 6: ANSI Color 6 */
        "#c0c5ce",              /* 7: ANSI Color 7 */
        "#65737e",              /* 8: ANSI Color 8 */
        "#bf616a",              /* 9: ANSI Color 9 */
        "#a3be8c",              /* 10: ANSI Color 10 */
        "#ebcb8b",              /* 11: ANSI Color 11 */
        "#8fa1b3",              /* 12: ANSI Color 12 */
        "#b48ead",              /* 13: ANSI Color 13 */
        "#96b5b4",              /* 14: ANSI Color 14 */
        "#eff1f5",              /* 15: ANSI Color 15 */
        [255] = 0,
        [256] = "#2b303b",              /* 256: Background */
        [257] = "#c0c5ce",              /* 257: Foreground */
        [258] = "#c0c5ce",              /* 258: Cursor */
        [259] = "#2b303b",              /* 259: Cursor Text */
        /* No support for text highlight coloring; would be #c0c5ce. */
        /* No support for highlight coloring; would be #4f5b66. */
        /* No support for bold coloring; would be #c0c5ce. */
};
