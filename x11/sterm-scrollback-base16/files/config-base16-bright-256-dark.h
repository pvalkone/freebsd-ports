...
static const char *colorname[] = {
        ...
        "#fb0120",              /* 1: ANSI Color 1 */
        "#a1c659",              /* 2: ANSI Color 2 */
        "#fda331",              /* 3: ANSI Color 3 */
        "#6fb3d2",              /* 4: ANSI Color 4 */
        "#d381c3",              /* 5: ANSI Color 5 */
        "#76c7b7",              /* 6: ANSI Color 6 */
        "#e0e0e0",              /* 7: ANSI Color 7 */
        "#b0b0b0",              /* 8: ANSI Color 8 */
        "#fb0120",              /* 9: ANSI Color 9 */
        "#a1c659",              /* 10: ANSI Color 10 */
        "#fda331",              /* 11: ANSI Color 11 */
        "#6fb3d2",              /* 12: ANSI Color 12 */
        "#d381c3",              /* 13: ANSI Color 13 */
        "#76c7b7",              /* 14: ANSI Color 14 */
        "#ffffff",              /* 15: ANSI Color 15 */
        [255] = 0,
        [256] = "#000000",              /* 256: Background */
        [257] = "#e0e0e0",              /* 257: Foreground */
        [258] = "#e0e0e0",              /* 258: Cursor */
        [259] = "#000000",              /* 259: Cursor Text */
        /* No support for text highlight coloring; would be #e0e0e0. */
        /* No support for highlight coloring; would be #505050. */
        /* No support for bold coloring; would be #e0e0e0. */
};
